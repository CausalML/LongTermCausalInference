...
# S1 as 1-2 quarters, S2 as 3-4 quarters, and S3 as 5-6 quarters. To generate the results in
# Tables 1 and 3-4 in the Supplementary Material, you may modify the list below according
# to the choice of quarters prescribed in each cell of those tables. For example, to generate
# the data in the second row of Table 1 in the supplement, you need to set:
