...
#
#To generate the result of each cell in Table 2 in the 
#main text or Table 10 in the supplement, you first need 
#to specify the dimension of X, S, U as well as the level 
#of nonlinearity q according to the setting of that cell.
#For example, if you would like to generate the result in 
#the bottom-left cell of Table 2 in the main text, set 
#dimX <- 5, dimS <- dimU <- 5 and q <- 2.
#
dimX <- 10
dimS <- dimU <- 5
q <- 2
