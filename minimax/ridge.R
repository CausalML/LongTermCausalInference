...
#
# Change the dimensions of X and S according to the settings 
# specified in each cell of the table. For example, to 
# replicate the simulation in the bottom-left cell of Table 1 
# in the main text, set dimX = 5 and dimS = 5.
#
dimX = 10
dimS = 5
nsim = 200
