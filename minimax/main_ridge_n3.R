...
for(idx in 1:length(data.list)){
  ...
  # obsX <- obsX[,c(3,4,6,12)]
  # expX <- expX[,c(3,4,6,12)]
  ...
  #estimate by Athey et al. via cross validation with elastic net
  h1 <- athey.cv.elnet(obsY[obsA == 1], obsS2[obsA == 1,], obsS1[obsA == 1,], obsX[obsA == 1,], obsS3[obsA == 1,])
  h0 <- athey.cv.elnet(obsY[obsA == 0], obsS2[obsA == 0,], obsS1[obsA == 0,], obsX[obsA == 0,], obsS3[obsA == 0,])
  tauatheyelnet <- mean(h1(cbind(expS3[expA == 1,], expS2[expA == 1,], expS1[expA == 1,], expX[expA == 1,])))
  tauatheyelnet <- tauatheyelnet - mean(h0(cbind(expS3[expA == 0,], expS2[expA == 0,], expS1[expA == 0,], expX[expA == 0,])))
  ...
  #                                 "tautrue", "truetau"))
  res.ridge.list4[[idx]] <- mget(c("tauridge1", "tauselridge1", "taudrridge1", "tauatheyridge", "tauatheycv", "tauatheyelnet", "tautrue", "truetau"))
